...
# python3 -u zoo/atari/entry/atari_eval_efficientzero.py
...
if __name__ == "__main__":
    ...
    from zoo.atari.config.atari_efficientzero_config import main_config, create_config
    ...
    model_path = None
    # model_path='data_efficientzero/_efficientzero_stack4_H5_seed0_260602_141543/ckpt/ckpt_best.pth.tar',
    ...
    main_config.env.eval_max_episode_steps = int(2000)
